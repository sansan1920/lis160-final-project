...
class AddRecordForm(forms.ModelForm):
		...
		curr_chapt = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Chapter Currently Reading", "class":"form-control"}), label="")	
		genre = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Genre", "class":"form-control"}), label="")
		status = forms.BooleanField(widget=forms.widgets.CheckboxInput(attrs={}), required=False, label="Is It Finished?")
